function initcity(city) {
  switch (document.creator["province"].value) { 
    ...
    case "海外" : var cityOptions = new Array( "请选择地区", "", "欧洲", "欧洲", "北美", "北美", "南美", "南美", "亚洲", "亚洲", "非洲", "非洲", "大洋洲", "大洋洲"); break; 
    default: var cityOptions = new Array("请选择地区", ""); break; 
  }
...
var province = $("#province_city").data("province");
var city = $("#province_city").data("city");
var name = $("#province_city").data("name");
//console.info($("#province_city").data("province"));
//console.info("-------"+name+"----city: "+city);
if (province) {
  creatprovince(province);
  initcity(city);
};
